...
void SwiGLUMlp::forward(const MlpWeights &weights, QwenSession &session,
    ...
    TensorTool::gemm(weights.s_gate_proj, g_in, g_gate, scratch, scratch_key::kInputLowp, "mlp.gate");
    TensorTool::gemm(weights.s_up_proj, g_in, g_up, scratch, scratch_key::kInputLowp, "mlp.up");
    ...
    TensorTool::gemm(weights.s_down_proj, g_prod, g_out, scratch, scratch_key::kProdLowp, "mlp.down");
