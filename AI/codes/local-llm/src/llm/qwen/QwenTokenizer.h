...
#ifndef LOCAL_LLM_QWENTOKENIZER_H
#define LOCAL_LLM_QWENTOKENIZER_H
...
// 仅基于 tokenizer.json（ByteLevel BPE）实现的 Qwen 分词器。
class QwenTokenizer {
public:
...
#endif //LOCAL_LLM_QWENTOKENIZER_H